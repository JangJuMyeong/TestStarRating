...
namespace TestStarRating
{
    ...
    public partial class RattingBar : ContentView
    {
        ...
        int commandParameterForStar0 = 1;
        ...
        int CommandParameterForStar6 = 5;
        public RattingBar()
        {
            InitializeComponent();
            //star0 = new Image();
            ...
            //star0.GestureRecognizers.Add(new TapGestureRecognizer
            //{
            //    Command = ItemTappedCommand,
            //    CommandParameter = commandParameterForStar0
            //});
            ...
            //star6.GestureRecognizers.Add(new TapGestureRecognizer
            //{
            //    Command = ItemTappedCommand,
            //    CommandParameter = CommandParameterForStar6
            //});
            #endregion
            //stkRattingbar.Children.Add(star0);
            ...
            //stkRattingbar.Children.Add(star6);
        }
        ...
        private static void ImageHeightPropertyChanged(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            if (control != null)
            {
                ...
                //control.star0.HeightRequest = (double)newValue;
                ...
                //control.star6.HeightRequest = (double)newValue;
            }
        ...
        private static void ImageWidthPropertyChanged(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            if (control != null)
            {
                //control.star0.WidthRequest = (double)newValue;
                ...
                //control.star6.WidthRequest = (double)newValue;
            }
        }
        #endregion
        ...
        private void PanGestureRecognizer_PanUpdated(object sender, PanUpdatedEventArgs e)
        {
            ...
            if (FlowDirection == FlowDirectionEnum.LeftToRight)
            {
                ...
                if(Device.RuntimePlatform == Device.iOS)
                {
                    ...
                    if (obj.TotalX < - (width * 3) && obj.TotalX > - (width * 4))
                    {
                        fillStar(2, this);
                        Command?.Execute(2);
                    }
                    if (obj.TotalX < - (width * 2) && obj.TotalX > - (width * 3))
                    {
                        fillStar(3, this);
                        Command?.Execute(3);

                    }
                    if (obj.TotalX < - width && obj.TotalX > - (width * 2))
                    {
                        fillStar(4, this);
                        Command?.Execute(4);

                    }
                    if (obj.TotalX < 0 && obj.TotalX > - width)
                    {
                        fillStar(5, this);
                        Command?.Execute(5);
                    }
